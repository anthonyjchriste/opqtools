...
var grid = (function() {
  ...
  function getGridPoints(distance) {
    ...
    // Adjust so that grid is always drawn from the same location
    //var latAdj = 128 - ((r * distance) % 128);
    //var lngAdj = 128 - ((c * distance) % 128);
    pointRow = getNextLatLng(pointRow.lat, pointRow.lng, bearing.SOUTH, 128 - distance);
    pointRow = getNextLatLng(pointRow.lat, pointRow.lng, bearing.EAST, 128 - distance);
